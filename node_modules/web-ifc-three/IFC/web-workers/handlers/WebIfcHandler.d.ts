...
export declare class WebIfcHandler implements WebIfcAPI {
    ...
    CreateModel(model: NewIfcModel, settings?: LoaderSettings): Promise<number>;
    ...
    GetNameFromTypeCode(type: number): Promise<string>;
    GetIfcEntityList(modelID: number): Promise<number[]>;
    GetTypeCodeFromName(modelID: number, typeName: string): Promise<number>;
